...
class AppStyle {
  ...
  static TextStyle txtInterMedium8Bluegray101 = TextStyle(
  ...
  static TextStyle txtInterMedium8Cyan300 = TextStyle(
    color: ColorConstant.cyan300,
    fontSize: getFontSize(
      8,
    ),
  ...
  static TextStyle txtInterSemiBold10Gray700 = TextStyle(
    color: ColorConstant.gray700,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle txtInterMedium9Bluegray101 = TextStyle(
    color: ColorConstant.bluegray101,
    fontSize: getFontSize(
      9,
    ),
